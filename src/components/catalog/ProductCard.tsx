...
export function ProductCard({ product, index = 0 }: ProductCardProps) {
  ...
  return (
    ...
    >
      {/* RGB Glow effect */}
      <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-neon-purple-500 via-neon-cyan-500 to-neon-purple-600 opacity-0 group-hover:opacity-60 blur-xl transition-all duration-500 animate-glow-pulse" />
      
      {/* Card container */}
      <div className="relative h-full rounded-2xl overflow-hidden bg-void-200 border border-neon-purple-500/20 group-hover:border-neon-cyan-400/40 transition-all duration-300">
        {/* Badges */}
        ...
        <div className="relative h-56 overflow-hidden bg-gradient-to-b from-void-300 to-void-200">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="relative w-48 h-48 group-hover:scale-105 transition-transform duration-500">
              {/* Glow under image */}
              <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-32 h-8 bg-neon-cyan-500/30 blur-xl rounded-full" />
              ...
              {/* Animated scan line */}
              <motion.div
                className="absolute inset-x-0 h-0.5 bg-gradient-to-r from-transparent via-neon-cyan-400 to-transparent opacity-0 group-hover:opacity-100"
                initial={{ top: '0%' }}
                animate={{ top: ['0%', '100%', '0%'] }}
        ...
        {/* Bottom glow line */}
        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-neon-purple-500 via-neon-cyan-500 to-neon-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      </div>
    </motion.article>
  );
}
