...
function TextRevealComponent({
  ...
  if (shouldReduceMotion) {
    return (
      <span
        ...
        className={cn(
          'inline-block',
          gradient && 'bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 bg-clip-text text-transparent',
          className
        )}
      >
        {children}
  ...
  return (
    <MotionComponent
      ...
      className={cn(
        'inline-block',
        gradient && 'bg-gradient-to-r from-purple-400 via-purple-300 to-purple-400 bg-clip-text text-transparent bg-[length:200%_auto]',
