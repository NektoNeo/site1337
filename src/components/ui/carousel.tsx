      ...
      return (
        <Button
          ...
          className={cn(
            ...
            prevButtonPositions[orientation || "horizontal"],
            className
          )}
    ...
    ({ className, variant = "outline", size = "icon", ...props }, ref) => {
      ...
      return (
        <Button
          ...
          className={cn(
            "absolute h-8 w-8 rounded-full",
            nextButtonPositions[orientation || "horizontal"],
            className
          )}
