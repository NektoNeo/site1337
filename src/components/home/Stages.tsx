...
const stages = [
  {
    ...
    description: 'Записываем ваш запрос, задачи и бюджет. Собираем конфигурацию без узких мест.',
  ...
  },
  {
    ...
    description: 'Согласовываем сборку, настраиваем BIOS/Windows, проводим стресс-тесты и замеряем шум.',
  ...
  },
  {
    ...
    description: 'Упаковываем, доставляем и подключаем. Даем гайды по FPS и остаемся на связи.',
