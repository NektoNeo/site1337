...
const gifts = [
  {
    icon: Shield,
    title: 'Год техподдержки',
    description: 'По железу и софту VA-PC. Отвечаем на вопросы и помогаем решать проблемы.',
    color: 'purple',
  },
  {
    icon: Wrench,
    title: 'Первое ТО бесплатно',
    description: 'Чистка через 6 месяцев без доплат — продлеваем жизнь вашему ПК.',
    color: 'cyan',
  },
  {
    icon: BookOpen,
    title: 'Профили и гайды',
    description: 'Профили FPS/работы и гайды по обслуживанию для максимальной производительности.',
    color: 'green',
  },
];
