  ...
  return (
    <motion.button
      ...
      className={`
        ...
        ${isSelected 
          ? 'bg-gradient-to-br from-purple-500/20 to-purple-500/20 border-2 border-purple-500/50' 
          : isIncompatible
    ...
    >
      ...
      {isSelected && (
        <motion.div
          className="absolute top-3 right-3 w-6 h-6 rounded-full bg-gradient-to-br from-purple-500 to-purple-500 flex items-center justify-center"
          initial={{ scale: 0 }}
          animate={{ scale: 1 }}
            ...
            <div className="relative w-full h-full rounded-2xl overflow-hidden glass-strong">
              ...
              <div className="relative flex items-center justify-between p-6 border-b border-white/10">
                <div className="flex items-center gap-4">
                  <div className="p-3 rounded-xl bg-gradient-to-br from-purple-500/20 to-purple-500/20 text-purple-400">
                    {CATEGORY_ICONS[category]}
                  </div>
                  <div>
                    <h2 className="text-xl font-inter font-bold text-gradient-purple">
