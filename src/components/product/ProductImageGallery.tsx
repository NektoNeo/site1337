  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        >
          {/* Subtle border (no spinning gradient) */}
          <div className="absolute -inset-[1px] rounded-2xl border border-purple-500/30" />
          ...
          >
            ...
            <div className="absolute bottom-4 right-4 bg-black/60 backdrop-blur-sm px-3 py-1.5 rounded-lg flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
              ...
              <span className="text-xs text-gray-300 font-medium">Нажмите для увеличения</span>
            </div>
