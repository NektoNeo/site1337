  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        ...
        >
          {/* RGB Animated Border */}
          <div className="absolute -inset-[2px] rounded-2xl bg-gradient-conic from-purple-500 via-purple-400 via-purple-500 to-purple-500 opacity-75 blur-sm group-hover:opacity-100 transition-opacity duration-500 animate-rgb-spin" />
          <div className="absolute -inset-[2px] rounded-2xl bg-gradient-conic from-purple-500 via-purple-400 via-purple-500 to-purple-500 opacity-50 animate-rgb-spin" />
        ...
        {isLightboxOpen && (
          ...
          >
            ...
            >
              ...
              <div className="absolute -inset-8 bg-gradient-to-r from-purple-500/20 via-purple-400/20 to-purple-500/20 blur-3xl" />
