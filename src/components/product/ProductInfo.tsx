...
function SpecBadge({ badge }: { badge: ProductBadge }) {
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-sm border border-purple-500/20 rounded-xl p-3 hover:border-purple-400/40 transition-colors">
    ...
    <div className="flex flex-col gap-6">
      ...
      >
        <h1 className="font-orbitron text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
          <span className="bg-gradient-to-r from-white via-purple-200 to-purple-200 bg-clip-text text-transparent">
            {product.name}
          </span>
        </h1>
      </motion.div>
        ...
        {hasDiscount && (
          <>
            ...
            <motion.span
              ...
              className="px-3 py-1 bg-gradient-to-r from-red-500 to-purple-500 rounded-full text-white text-sm font-bold"
            >
              -{discountPercent}%
            </motion.span>
          </>
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-500 transition-all duration-300" />

          {/* Pulsing glow effect */}
          <div className="absolute inset-0 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-500 blur-xl opacity-50 group-hover:opacity-75 animate-pulse-glow" />
        ...
        <button
          onClick={onAddToCart}
          disabled={!product.inStock}
          className="group relative py-4 px-6 rounded-xl font-semibold text-white border-2 border-purple-500/50 hover:border-purple-400 transition-all duration-300 overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {/* Background on hover */}
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-purple-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
