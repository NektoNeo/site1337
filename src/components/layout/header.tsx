  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Animated underline */}
        <motion.span
          className="absolute bottom-0 left-1/2 h-0.5 bg-gradient-to-r from-neon-purple via-neon-magenta to-neon-purple"
        ...
        />
        <motion.span
          className="absolute top-0 right-0 w-2 h-2 border-r border-t border-neon-magenta/0 rounded-tr"
          whileHover={{ borderColor: "rgba(255, 30, 142, 0.5)" }}
        />
        <motion.span
          className="absolute bottom-0 left-0 w-2 h-2 border-l border-b border-neon-magenta/0 rounded-bl"
          whileHover={{ borderColor: "rgba(255, 30, 142, 0.5)" }}
        />
        <motion.span
      ...
      {itemCount > 0 && (
        <motion.span
          ...
          className={cn(
            ...
            "bg-gradient-to-r from-neon-purple to-neon-magenta",
...
function SearchButton({ onClick }: { onClick?: () => void }) {
  return (
    <button
      onClick={onClick}
      className="p-2 rounded-lg transition-all duration-300 hover:bg-neon-magenta/10 group"
      aria-label="Поиск"
    >
      <Search className="w-6 h-6 text-white/80 group-hover:text-neon-magenta transition-colors duration-300" />
    </button>
  );
}
              ...
              <div className="px-4 py-3 border-t border-glass-border">
                ...
                <div className="flex flex-wrap gap-2">
                  {["RTX 4090", "Gaming PC", "Workstation", "Streaming"].map((tag) => (
                    <button
                      key={tag}
                      className="px-3 py-1 text-sm font-display text-neon-magenta/80 border border-neon-magenta/20 rounded-full hover:bg-neon-magenta/10 hover:border-neon-magenta/40 transition-all"
                    >
                      {tag}
                    </button>
                  ))}
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: isScrolled
              ? "linear-gradient(90deg, transparent, rgba(139,92,246,0.1) 20%, rgba(255,30,142,0.1) 80%, transparent)"
              : "transparent",
          }}
          animate={{
          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-2">
              ...
              <a
                ...
                className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg bg-gradient-to-r from-neon-purple to-neon-magenta text-white text-sm font-semibold transition-all duration-300 hover:shadow-neon-magenta hover:scale-105"
              >
        ...
        >
          <motion.div
            ...
            style={{
              background: "linear-gradient(90deg, transparent, #8B5CF6, #FF1E8E, #EC4899, #8B5CF6, transparent)",
            }}
            animate={{
              x: ["-50%", "0%"],
            }}
